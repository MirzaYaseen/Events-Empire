...
const FIREBASE_API_ENDPOINT =
  'https://xyzy-9f466-default-rtdb.firebaseio.com/OrderDirectly';
            ...
            <View style={{marginTop: 40, marginBottom: 40}}>
              ...
              <Text
                ...
                <Text style={{color: 'white'}}>
                  Click on 'Order Directly' in just this case if you want to
    ...
    return (
      <View>
        <View style={{flexDirection: 'row', marginTop: 40, marginBottom: 20}}>
          ...
          <Text style={{marginLeft: 10, fontSize: 20}}>Order</Text>
        </View>
