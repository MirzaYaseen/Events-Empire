...
const ManageOrders = ({navigation}) => {
  ...
  const getOrders = async () => {
    ...
    setloading(true);
    axios
      .get('https://xyzy-9f466-default-rtdb.firebaseio.com//Appointments.json')
      .then(response => {
  ...
  if (isloading) {
    return (
      <View style={{alignItems: 'center', marginTop: 250}}>
        <Text style={{fontSize: 25}}>Wait a moment...</Text>
      </View>
    );
  }
  return (
