...
const PhotographerPayment = ({navigation, route}) => {
  ...
  const onDone = async() => {
    ...
    //   'https://backendserver.onrender.com/photographer/addServicesOrder',
    //   {
    //     shippingInfo: props.shippingInfo,
    //     name: props.otherParam.name,
    //     time: props.time,
    //     orderItems: props.otherParam.name,
    //     totalPrice: props.otherParam.price,
    //     date: props.date,
    //     seller: props.otherParam.seller,
    //     user: user?._id,
    //   },
    // );
...
export default PhotographerPayment;
