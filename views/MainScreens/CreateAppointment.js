...
const SearchandServices = () => {
  ...
  React.useEffect(() => {
    fetch('https://backendserver.onrender.com/service/viewphotographer')
  ...
  const ItemView = ({item}) => {
    return (
      ...
      <TouchableOpacity
        onPress={() =>
          navigation.navigate('InsideStore', {
            otherParam: item,
          })
        }>
        <View style={style.card}>
          ...
          <Text style={style.TextStyle4}>PKR. {item.basicPlan.price}</Text>
        </View>
      </TouchableOpacity>
    );
  };
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setFilteredDataSource(
                  filteredDataSource.sort((a, b) => a.basicPlan.price - b.basicPlan.price),
                );
                setVisible(false);
              }}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setFilteredDataSource(
                  filteredDataSource.sort((a, b) => b.basicPlan.price - a.basicPlan.price),
                );
                setVisible(false);
              }}>
              <Text style={{fontSize: 18, color: '#000'}}>
...
export default SearchandServices;
